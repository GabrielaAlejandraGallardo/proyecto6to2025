...
class Jugador(models.Model):
  ...
  enviado_whatsapp = models.BooleanField(default=False, verbose_name="Mensaje WhatsApp enviado")
  ...
  def save(self, *args, **kwargs):
    ...
    qr_content = f'Jugador: {self.nom}, DNI: {self.DNI}, Fecha Nacimiento: {self.fechan}, Altura: {self.altura}, Peso: {self.peso}, Direccion: {self.dire}, Codigo Postal: {self.cd}, Talla: {self.talla}, Deporte: {self.descripcion}, WhatsApp: {self.whatsapp}, Cuota: {self.idCuota.importe if self.idCuota else "N/A"}'
